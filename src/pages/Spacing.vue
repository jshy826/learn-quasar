    ...
    <section class="q-mb-xl">
      ...
      <div class="bg-primary q-pa-xs q-mt-md">
        <div class="bg-dark text-white">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. In ipsa quia
          velit. Hic pariatur eaque, libero quia ut error facilis atque
          laboriosam incidunt cupiditate dolore laudantium doloremque velit!
          Tenetur, culpa?
        </div>
      </div>
