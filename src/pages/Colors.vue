  ...
  <q-page class="q-pa-xl">
    <section class="q-mb-xl">
      ...
      <div class="q-gutter-sm">
        ...
        <div class="q-pa-xs rounded-borders bg-orange-4 text-white">
          orange-4
        </div>
        <div class="q-pa-xs rounded-borders bg-light-green-6 text-white">
          light-green-6
        </div>
        <div class="q-pa-xs rounded-borders bg-blue-grey-1 text-white">
          blue-grey-1
        </div>
